 ...
 * including parsing nodes, attributes and operations. If successful, the parsing results in a map with the id as key and values of
 * <{@link Node}s with attributes, operations and all the necessary properties that could be read
 * from the XMI-file. Relations are not parsed.
 *
...
public class ArgoUMLNodeParser {
     ...
     * @return a list of {@link Node}s including attributes and operations.
     */
    ...
    /**
     * Create a class or interface and add it to the {@link Node}s map.
	 * @param event
	 */
  ...
  /**
    ...
    /**
     * Create a operation WITHOUT types (null) of return and parameters and add it to the operations of Node. 
   ...
   /**
    * Create or find the node of this particular Datatype 
    * and set this type to the corresponding {@link Attribute} or {@link Parameter}.
    * 
    * @param event
    */
    ...
    /**
     * If the kind of the {@link Parameter} is 'in' create a Parameter without type,
     * else (the kind is 'return') remember the {@link Operation} under consideration.
     * Types will be set as a special handling of the CLASS/INTERFACE event.
     * 
	 * @param event
	 */
	private void handleParameterEvent(XMLEvent event) {
        ...
        if ("in".equals(attributes.get(KIND))) {
            parameter = createIncompleteParameter(event, operation);
        } else {
