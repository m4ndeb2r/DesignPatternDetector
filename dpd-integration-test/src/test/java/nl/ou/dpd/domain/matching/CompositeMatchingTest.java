...
public class CompositeMatchingTest extends AbstractMatchingTest {
    ...
    public void testMatchingCommposite() {
        ...
        final URL sucXmiUrl = CompositeMatchingTest.class.getResource(MATCHING_SYSTEM_XMI);
    ...
    public void testMismatchingComposite() {
        final ArgoUMLParser xmiParser = ParserFactory.createArgoUMLParser();
        final URL sucXmiUrl = CompositeMatchingTest.class.getResource(MISMATCHING_SYSTEM_XMI);
        final SystemUnderConsideration system = xmiParser.parse(sucXmiUrl);
