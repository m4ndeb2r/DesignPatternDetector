...
/**
 * Test the matching process for a Strategy pattern.
 *
 * @author Martin de Boer
 */
@Category(IntegrationTest.class)
public class StrategyMatchingTest extends AbstractMatchingTest {
    ...
    public void initTests() {
        ...
        final String patternsXmlFile = StrategyMatchingTest.class.getResource(TEMPLATES_XML).getFile();
        designPattern = getDesignPatternByName(patternsParser.parse(patternsXmlFile), PATTERN_NAME);
    }

    @Test
    public void testMatchingStrategy() {
